...
# api_url = "https://injection.texnet.beg.utexas.edu/api/well/wellswithinjectioncsv"
...
DisposalWellFile='../data/disposalWellsB3Format.csv'
# B3WellFile='../data/b3Wells.csv'
...
TXDailyFile='../data/disposalDataInj.csv'

TXDTempWFile='../data/injectionV3_output_well.csv'
# TXDTempMFile='/data/xom/seismicity/bcurry/GIST/TestTXMonthlyInjDeep.csv'
TXDTempDFile='../data/injectionV3_output_inj.csv'
...
DeepWellFile='../data/injectionV3_output_well.csv'
DeepInjFile='../data/injectionV3_output_inj.csv'
DeepPrefix='../data/injectionV3_processed'
...
TXDInj=inj3.injTX(DisposalWellFile,'Deep',7000.,TXDTempWFile)
...
DeepWells=inj3.inj(None,TXDInj,'01-01-1980',DeepWellFile,DeepInjFile)
DeepWells.processRates(200000.,1,'09-18-2024',False, 1)
